...
class BobTest(unittest.TestCase):
    def test_stating_something(self):
        self.assertEqual(response("Tam-ay-to, tom-aaaah-to."), "Whatever.")
    ...
    def test_non_letters_with_question_mark(self):
        self.assertEqual(response(":) ?"), "Sure.")

    def test_prattling_on(self):
        self.assertEqual(response("Whait! Hang on. Are you going to be OK?"), "Sure.")
