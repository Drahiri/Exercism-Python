...
class GhostGobbleGameTest(unittest.TestCase):
    ...
    def test_ghost_does_not_get_eaten_because_no_power_pellet_active(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the ghost **does not** get eaten because "
    ...
    def test_score_when_eating_dot(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player scores because they were touching a dot."
        )
        self.assertIs(actual_result, True, msg=error_message)
    ...
    def test_score_when_eating_power_pellet(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player scores because they were "
    ...
    def test_no_score_when_nothing_eaten(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player **does not**  scores because "
    ...
    def test_lose_if_touching_a_ghost_without_a_power_pellet_active(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player loses because he touched "
    ...
    def test_dont_lose_if_touching_a_ghost_with_a_power_pellet_active(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player **does not** lose because when they "
            "touched a ghost, a power pellet was activate."
        )
        self.assertIs(actual_result, False, msg=error_message)
    ...
    def test_dont_lose_if_not_touching_a_ghost(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player **does not** lose because they "
            "were not touching a ghost."
        )
        self.assertIs(actual_result, False, msg=error_message)
    ...
    def test_win_if_all_dots_eaten(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player wins because all the dots "
            "were eaten."
        )
        self.assertIs(actual_result, True, msg=error_message)
    ...
    def test_dont_win_if_all_dots_eaten_but_touching_a_ghost(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player **does not** win, because "
    ...
    def test_win_if_all_dots_eaten_and_touching_a_ghost_with_a_power_pellet_active(
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player wins, because "
            "a power pellet was active when they touched a ghost."
        )
        self.assertIs(actual_result, True, msg=error_message)
    ...
    def test_dont_win_if_not_all_dots_eaten(self):
        ...
        error_message = (
            ...
            f"The function returned {actual_result}, but the "
            "tests expected that the player **does not** win, because "
            "the player did not eat all the dots."
        )
        self.assertIs(actual_result, False, msg=error_message)
