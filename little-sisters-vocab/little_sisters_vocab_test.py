...
from little_sisters_vocab import (
    add_prefix_un,
    make_word_groups,
    remove_suffix_ness,
    adjective_to_verb,
...
class LittleSistersVocabTest(unittest.TestCase):
    ...
    def test_make_word_groups_en(self):
        ...
        error_message = (
            ...
            f'The function returned "{actual_result}", but the '
            f'tests expected "{expected}" for the word gropus.'
        )
        self.assertEqual(actual_result, expected, msg=error_message)
    ...
    def test_make_word_groups_auto(self):
        ...
        expected = (
            "auto :: autodiodactic :: autograph :: automate :: autochrome :: "
    ...
    @pytest.mark.task(taskno=2)
    def test_make_word_groups_inter(self):
        input_data = [
            "inter",
            "twine",
            "connected",
        ...
        for variant, (word, expected) in enumerate(
            ...
            with self.subTest(f"variation #{variant}", word=word, expected=expected):
                ...
                error_message = (
                    ...
                    f'The function returned "{actual_result}", but the '
                    f'tests expected "{expected}" after the suffix was removed.'
                )
                self.assertEqual(actual_result, expected, msg=error_message)
    ...
    def test_adjective_to_verb(self):
        input_data = [
            ...
            "The black oil got in the white dog.",
        ]
        ...
        for variant, (sentence, index, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_message = (
                    ...
                    f'The function returned "{actual_result}", but the '
                    f'tests expected "{expected}" as the verb for '
