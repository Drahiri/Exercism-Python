...
def value_of_card(card: str) -> int:
    ...
    1. 'J', 'Q', 'K' (otherwise known as "face cards") = 10
    2. 'A' (ace card) = 1
...
def higher_card(card_one: str, card_two: str) -> str | tuple[str, str]:
    ...
    :return: str or tuple - resulting Tuple contains both cards if they are equal value.
...
def value_of_ace(card_one: str, card_two: str) -> int:
    ...
    """
    ace_as_11 = 11
    amount = value_of_card(card_one) + value_of_card(card_two) + ace_as_11
...
def can_double_down(card_one, card_two):
    ...
    :return: bool - can the hand double down? (i.e. totals 9, 10 or 11 points).
    """
    pass
