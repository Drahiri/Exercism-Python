        ...
        for variant, ((rounds_1, rounds_2), expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_message = (
                    ...
                    f"The function returned {actual_result}, "
                    f"but the tests expected {expected} as the concatenation "
        ...
        for variant, (hand, expected) in enumerate(
            ...
            with self.subTest(f"variation #{variant}", hand=hand, expected=expected):
                ...
                error_message = (
                    ...
                    f"The function returned {actual_result}, "
                    f"but the {hand} {'does' if expected else 'does not'} "
        ...
        for variant, (input_hand, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_message = (
                    ...
                    f"The function returned {actual_result}, "
                    f"but the hand {'does' if expected else 'does not'} "
                    f"yield teh same odd-even average."
                )
